...
public class testMain extends Activity {
    ...
    private communication.managerBT mManagerBT = null;
    ...
    protected void onStop() {
        super.onStop();
        if (mBTBound) {
            sendMessage("OPERATION/DISCONNECT/" + mLocalDeviceMacAddress);
...
//                    break;
    ...
    private void setupChat() {
        ...
        mSendButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if( mManagerBT.getmConnThreads() == null)
                    return;
    ...
    private void updateConnectionDevice()
    {
        ...
        ((TextView)findViewById(R.id.tvConnectedDevice)).setText(mManagerBT.getmConnThreads().getDeviceName());
    }
